...
public class GyroController : MonoBehaviour
{
	...
	Quaternion qRefCam = Quaternion.identity;
    Gyroscope gyro;
    ...
    void Update()
    {
        if (controlledObject != null && !Paused)
        {
            ...
            //   data from gyroscope
			Quaternion nRg = gyro.attitude;
			nRg = ConvertRotation (nRg);
			controlledObject.transform.rotation = qRefObject * (Quaternion.Inverse (qRefGyro) * nRg);
        }
    }
